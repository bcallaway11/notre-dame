...
1. Introduction to DID & Textbook 2 Period Case
...
<span class="alert">Additional Workshop Materials: </span> [https://bcallaway11.github.io/notre-dame/](https://bcallaway11.github.io/notre-dame/)
...
\begin{align*}
  ATT = \color{green}{\E[Y_{t=2}(1) - Y_{t=1}(0) | G=1]} - \color{red}{\E[Y_{t=2}(0) - Y_{t=1}(0) | G=1]}
\end{align*}
...
* There are many possibilities here:
    1. <span class="alert-blue">Before-after: </span> $\color{red}{\E[Y_{t=2}(0) - Y_{t=1}(0) | G=1]} = 0$
...
* There are many possibilities here:
    2. <span class="alert-blue">Lagged outcome unconfoundedness: </span> $\color{red}{\E[Y_{t=2}(0) - Y_{t=1}(0) | G=1]} = \E\Big[ \E[Y_{t=2}(0) - Y_{t=1}(0) | Y_{t=1}, G=0] \Big| G=1\Big]$
...
* There are many possibilities here:
    3. <span class="alert-blue">Change-in-changes: </span> $\color{red}{\E[Y_{t=2}(0) - Y_{t=1}(0) | G=1]} = \E\Big[ Q_{Y_{t=2}(0)|G=0}\big(F_{Y_{t=1}(0)|G=0}(Y_{t=1}(0))\big) - Y_{t=1}(0) \Big| G=1\Big]$
...
eqlist <- list("ATT &= \\E[\\Delta Y | G=1] - \\E[\\Delta Y(0) | G=1]",
...
4. Handle covariates in different ways
    ...
    * In @caetano-callaway-2023, we consider including both changes and levels of covariates
